Route13Object:
	...
	db $a ; objects
	object SPRITE_ROCKER, $31, $a, STAY, RIGHT, $1, OPP_BIRD_KEEPER, $1
	...
	object SPRITE_ROCKER, $c, $4, STAY, RIGHT, $6, OPP_BIRD_KEEPER, $2
	...
	object SPRITE_ROCKER, $7, $d, STAY, UP, $a, OPP_BIRD_KEEPER, $3
