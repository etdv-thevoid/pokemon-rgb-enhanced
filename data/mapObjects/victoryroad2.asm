VictoryRoad2Object:
	...
	object SPRITE_ROCKER, $15, $d, STAY, LEFT, $2, OPP_JUGGLER, $6
	object SPRITE_ROCKER, $13, $8, STAY, DOWN, $3, OPP_TAMER, $5
	object SPRITE_BLACK_HAIR_BOY_2, $4, $2, STAY, DOWN, $4, OPP_POKEMANIAC, $6
	object SPRITE_ROCKER, $1a, $3, STAY, LEFT, $5, OPP_JUGGLER, $7
	...
	object SPRITE_BALL, $9, $b, STAY, NONE, $9, TM_09
