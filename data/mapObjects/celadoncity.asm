CeladonCityObject:
	...
	db $d ; warps
	db $b, $8, $0, CELADON_MART_1
	db $b, $a, $2, CELADON_MART_1
	db $9, $18, $0, CELADON_MANSION_1
	db $3, $16, $2, CELADON_MANSION_1
	db $3, $17, $2, CELADON_MANSION_1
	...
	db $1b, $1b, $0, CELADON_DINER
	db $1b, $1f, $0, CELADON_HOUSE
	db $1b, $28, $0, CELADON_HOTEL
	...
	db $9, $13, $e ; CeladonCityText14
	db $b, $c, $f ; CeladonCityText15
	...
	; warp-to
	EVENT_DISP CELADON_CITY_WIDTH, $b, $8 ; CELADON_MART_1
	EVENT_DISP CELADON_CITY_WIDTH, $b, $a ; CELADON_MART_1
	EVENT_DISP CELADON_CITY_WIDTH, $9, $18 ; CELADON_MANSION_1
	EVENT_DISP CELADON_CITY_WIDTH, $3, $16 ; CELADON_MANSION_1
	EVENT_DISP CELADON_CITY_WIDTH, $3, $17 ; CELADON_MANSION_1
	...
	EVENT_DISP CELADON_CITY_WIDTH, $1b, $1b ; CELADON_DINER
	EVENT_DISP CELADON_CITY_WIDTH, $1b, $1f ; CELADON_HOUSE
	EVENT_DISP CELADON_CITY_WIDTH, $1b, $28 ; CELADON_HOTEL
