Route10Object:
	...
	db $6 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, $b, $2b, STAY, LEFT, $1, OPP_POKEMANIAC, $1
	object SPRITE_HIKER, $3, $39, STAY, UP, $2, OPP_HIKER, $7
	object SPRITE_BLACK_HAIR_BOY_2, $e, $40, STAY, LEFT, $3, OPP_POKEMANIAC, $2
	object SPRITE_LASS, $7, $16, STAY, LEFT, $4, OPP_JR_TRAINER_F, $7
	...
	EVENT_DISP ROUTE_10_WIDTH, $23, $3 ; POWER_PLANT
