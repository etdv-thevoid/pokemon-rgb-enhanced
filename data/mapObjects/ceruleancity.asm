CeruleanCityObject:
	...
	db $b, $b, $1, CERULEAN_HOUSE_2
	db $9, $b, $0, CERULEAN_HOUSE_2
	...
	object SPRITE_COP_GUARD, $1c, $c, STAY, DOWN, $6 ; person
	...
	object SPRITE_COP_GUARD, $1b, $c, STAY, DOWN, $b ; person

	; warp-to
	EVENT_DISP CERULEAN_CITY_WIDTH, $b, $1b ; TRASHED_HOUSE
	EVENT_DISP CERULEAN_CITY_WIDTH, $f, $f ; CERULEAN_HOUSE_1
	...
	EVENT_DISP CERULEAN_CITY_WIDTH, $b, $b ; CERULEAN_HOUSE_2
	EVENT_DISP CERULEAN_CITY_WIDTH, $9, $b ; CERULEAN_HOUSE_2
