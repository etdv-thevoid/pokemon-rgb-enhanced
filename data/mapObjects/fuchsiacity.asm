FuchsiaCityObject:
	...
	object SPRITE_ROCKER, $e, $f, STAY, DOWN, $3 ; person
	...
	object SPRITE_SLOWBRO, $1e, $d, WALK, $2, $8 ; person
	...
	EVENT_DISP FUCHSIA_CITY_WIDTH, $1b, $d ; FUCHSIA_HOUSE_1
	...
	EVENT_DISP FUCHSIA_CITY_WIDTH, $1b, $8 ; FUCHSIA_GYM
