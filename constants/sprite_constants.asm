...
const_value = 0
	...
	const SPRITE_BULBASAUR  ; $A
	const SPRITE_CHARMANDER ; $B
	const SPRITE_SQUIRTLE   ; $C
...
const_value = 1 ; start at 1
	...
	const SPRITE_MISTY                     ; $41
	const SPRITE_SABRINA                   ; $42
	const SPRITE_SURGE                     ; $43
	const SPRITE_ROCKET_F                  ; $44
; 1-FRAME SPRITES START HERE
	const SPRITE_BALL
	const SPRITE_OMANYTE
	const SPRITE_BOULDER
	const SPRITE_PAPER_SHEET
	const SPRITE_BOOK_MAP_DEX
	const SPRITE_CLIPBOARD
	const SPRITE_SNORLAX
	const SPRITE_OLD_AMBER
	const SPRITE_LYING_OLD_MAN
