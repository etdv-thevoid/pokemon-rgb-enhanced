...
const_value = 0
	...
	const UNUSED_EFFECT_01           ; $01 UNUSED
	const POISON_SIDE_EFFECT1        ; $02 Poison Sting
	const DRAIN_HP_EFFECT            ; $03 Absorb, Mega Drain, Leech Life
	const BURN_SIDE_EFFECT1          ; $04 All Fire attacks
	const FREEZE_SIDE_EFFECT1        ; $05 All Ice attacks
	const PARALYZE_SIDE_EFFECT1      ; $06 All Electric moves
	...
	const UNUSED_EFFECT_1E           ; $1E UNUSED
	const FLINCH_SIDE_EFFECT1        ; $1F
	const SLEEP_EFFECT               ; $20
	const POISON_SIDE_EFFECT2        ; $21 Smog, Sludge
	const BURN_SIDE_EFFECT2          ; $22 Fire Blast
	const FREEZE_SIDE_EFFECT2        ; $23 Blizzard
	const PARALYZE_SIDE_EFFECT2      ; $24 Thunder
	...
	const JUMP_KICK_EFFECT           ; $2D Jump Kick and Sky Uppercut effect
	...
	const UNUSED_EFFECT_48           ; $48 UNUSED
	const UNUSED_EFFECT_49           ; $49 UNUSED
	const UNUSED_EFFECT_4A           ; $4A UNUSED
	const TRI_ATTACK_EFFECT          ; $4B
	const CONFUSION_SIDE_EFFECT      ; $4C
	const TWINEEDLE_EFFECT           ; $4D
	const UNUSED_EFFECT_4E           ; $4E UNUSED
