...
MoveReminderGreetingText:
	TX_FAR _MoveReminderGreetingText
	db "@"

MoveReminderSaidYesText:
	TX_FAR _MoveReminderSaidYesText
	db "@"

MoveReminderNotEnoughMoneyText:
	TX_FAR _MoveReminderNotEnoughMoneyText
	db "@"

MoveReminderWhichMoveText:
	TX_FAR _MoveReminderWhichMoveText
	db "@"

MoveReminderByeText:
	TX_FAR _MoveReminderByeText
	db "@"

MoveReminderNoMovesText:
	TX_FAR _MoveReminderNoMovesText
	db "@"
